<div class="content-page">
    <div class="container-fluid">
        <a href="<?= base_url('Admin/TanggapanController/tanggapan_selesai/') ?>" class="btn btn-dark"><i class="las la-arrow-left">Back</i></a>
        <hr>
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-lg-12 card-profile">
                    <div class="card card-block card-stretch card-height">
                        ...
                        <div class="text-center mb-2">
                            <button class="btn btn-primary col-4" name="detail" data-toggle="modal" data-target="#BuktiSelesaiModal"><i class="las la-calendar-check"></i>Lihat Bukti Selesai</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h5 class="card-title">Tanggal Selesai Dikerjakan : <span class="text-success"><?= $data_pengaduan['tgl_selesai'] ?></span></h5>
                <h5 class="card-title">Pesan : <span class="text-muted"><?= $data_pengaduan['pesan'] ?></span></h5>
