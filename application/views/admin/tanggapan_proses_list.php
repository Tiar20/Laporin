        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <hr>
                    <?= form_open_multipart('Admin/BuktiSelesaiController/'); ?>
                    <input type="hidden" name="id" value="<?= $dp['id_pengaduan']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <small id="foto_bukti" class="form-text text-danger">*Foto yang di upload adalah foto bukti laporan telah selesai dikerjakan.
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="las la-check-double"></i>Selesaikan Laporan</button>
                    <?= form_close(); ?>
                </div>
            </div>
        </div>
